...
Процедура ГСД_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	Если ВключитьПоказСуммВыделенныхСтрок Тогда              
		...
		ДоработкаФормыСервер.ДобавитьРеквизитИЭлементФормы(ЭтотОбъект, Элементы.ГруппаИтоговПоДокументу,ИмяРеквизитаСРезультатомСуммирования);
...
Процедура ГСД_РассчитатьСуммуВыделенныхСтрокНачисления()   
	Если ВключитьПоказСуммВыделенныхСтрок Тогда	
		ДоработкаФормыКлиент.РассчитатьСуммуВыделенныхСтрок(ЭтаФорма,"Начисления","Результат",ИмяРеквизитаСРезультатомСуммирования); 
	КонецЕсли;	
...
Процедура ГСД_РассчитатьСуммуВыделенныхСтрокНДФЛ()
	Если ВключитьПоказСуммВыделенныхСтрок Тогда	
		ДоработкаФормыКлиент.РассчитатьСуммуВыделенныхСтрок(ЭтаФорма,"НДФЛ","Налог",ИмяРеквизитаСРезультатомСуммирования); 
	КонецЕсли;		
КонецПроцедуры
...
Процедура ГСД_РассчитатьСуммуВыделенныхСтрокУдержания()
	Если ВключитьПоказСуммВыделенныхСтрок Тогда	
		ДоработкаФормыКлиент.РассчитатьСуммуВыделенныхСтрок(ЭтаФорма,"Удержания","Результат",ИмяРеквизитаСРезультатомСуммирования); 		
	КонецЕсли;		
