...
// Добавить группу для реквизитов.
// 
// Параметры:
//  Форма -Форма
...
//	ЗаголовокЭлемента -Строка- заголовок поля формы
//
...
// Параметры:
//  Форма			 - ФормаКлиентскогоПриложения - форма, для которой добавляется реквизит.
//  ГруппаРеквизитов-ГруппаФормы-группа формы, которой будет подчиняться добавляемый реквизит.
//  ИмяРеквизита - Строка - наименование добавляемого реквизита и связанного с ним элемента.
//  ПрефиксПодсказки - Строка -
//  ПрефиксПодсказкиДоп - Строка - 
//
...
//  Форма - Форма - 
//  ГруппаРеквизитов - ГруппаФормы - - группа формы, которой будет подчиняться добавляемый реквизит.
//  КомандаДействие - Строка - имя процедуры обработки действия
...
// Вывести таблицу значений в табличный документ.
// 
// Параметры:
//  ТабДок -ТабличныйДокумент-Таб док
//  ТабЗн-ТаблицаЗначений- выводимая таблица
//
Процедура ВывестиТаблицуЗначенийВТабличныйДокумент(ТабДок,ТабЗн) Экспорт

	ПостроительОтчета=Новый ПостроительОтчета;
	ИсточникДанных=Новый ОписаниеИсточникаДанных(ТабЗн);
